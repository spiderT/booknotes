...
- [网络协议](#网络协议)
  ...
  - [4. 网络层](#4-网络层)
    ...
    - [地址解析协议 ARP](#地址解析协议-arp)
      - [使用 ARP 的四种典型情况](#使用-arp-的四种典型情况)
    - [IP 数据报的格式](#ip-数据报的格式)
    - [划分子网](#划分子网)
      - [子网掩码的概述及作用](#子网掩码的概述及作用)
      - [为什么要使用子网掩码](#为什么要使用子网掩码)
      - [子网掩码的分类](#子网掩码的分类)
        - [缺省子网掩码](#缺省子网掩码)
        - [自定义子网掩码](#自定义子网掩码)
      ...
      - [子网划分](#子网划分)
      - [子网掩码计算](#子网掩码计算)
        - [1、利用子网数来计算](#1利用子网数来计算)
        - [2、利用主机数来计算](#2利用主机数来计算)
    - [无分类编址 CIDR](#无分类编址-cidr)
    - [网际控制报文协议](#网际控制报文协议)
      - [ICMP协议是一个网络层协议](#icmp协议是一个网络层协议)
      - [ICMP协议的功能](#icmp协议的功能)
      - [ICMP 报文的种类](#icmp-报文的种类)
      - [ICMP 差错报告报文共有 5 种](#icmp-差错报告报文共有-5-种)
      - [不应发送 ICMP 差错报告报文的几种情况](#不应发送-icmp-差错报告报文的几种情况)
    - [自治系统 AS(Autonomous System)](#自治系统-asautonomous-system)
    - [内部网关协议 RIP (Routing Information Protocol)](#内部网关协议-rip-routing-information-protocol)
    - [OSPF](#ospf)
      - [OSPF协议基本原理](#ospf协议基本原理)
      - [OSPF 直接用 IP 数据报传送](#ospf-直接用-ip-数据报传送)
    - [外部网关协议 BGP](#外部网关协议-bgp)
    - [网际组管理协议 IGMP](#网际组管理协议-igmp)
